...
const rangeTypeList = ["self", "touch", "ranged", "area of effect", "cone of effect", "cube of effect", "cylinder of effect", "line of effect", "sphere of effect"];
...
Spell.prototype.setCastingTimeType = function (castingTimeType){
    if (this.castingTime = 0){
        this.castingTimeType = 0;
    }
    else if (castingTimeType!= null){
...
//function for showing choices for correct data
function spellIsAttackData() {
    var display = document.getElementById("attackCheck");
    var area = document.getElementById("hiddenAttackChoices");
  ...
  function spellHasDuration() {
    var display = document.getElementById("castingCost");
    var area = document.getElementById("hiddenDurationChoices");
  
    if (display.value == "duration of concentration"){
      area.style.display = "inline";
    } else {
      area.style.display = "none";
    }
  ...
  function spellHasMaterialComponents() {
    var display = document.getElementById("materialComponent");
    var area = document.getElementById("hiddenMaterialComponents");
  ...
  function addMaterial() {
    var text = document.getElementById("individualComponent");
    var area = document.getElementById("materialList");
  
    var input = document.getElementById("myInput");

    input.addEventListener("keypress", function(event){
    if (event.key === "Enter"){
        area.textContent+= text.textContent;
        text.textContent = "";
    }
  });
  }

  function spellHasSubclasses() {
    var display = document.getElementById("hasSubClassList");
    var area = document.getElementById("hiddenSubClassComponents");
  ...
  function spellHasSubclasses() {
    var text = document.getElementById("subclass");
    var area = document.getElementById("subClassList");
